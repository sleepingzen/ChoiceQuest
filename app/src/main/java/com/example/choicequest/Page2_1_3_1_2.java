...
public class Page2_1_3_1_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_1_3_1_2);
        View root = findViewById(R.id.page2_1_3_1_2);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.page2_1_3_1_2), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });

        myTextView = findViewById(R.id.tv_page2_1_3_1_2);
    ...
    public void title30(View view){
        Intent i = new Intent(Page2_1_3_1_2.this, MainActivity.class);
        startActivity(i);
        finish();
    }
}