...
public class Page2_1_2_3_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_1_2_3_1);
        View root = findViewById(R.id.page2_1_2_3_1);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.page2_1_2_3_1), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });

        myTextView = findViewById(R.id.tv_page2_1_2_3_1);
