...
public class Page2_2 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View root = findViewById(R.id.page2_2);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.page2_2), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });

        myTextView = findViewById(R.id.tv_page2_2);
    ...
    public void page2_2_1(View view){
        Intent i = new Intent(Page2_2.this, Page2_2_1.class);
        startActivity(i);
        finish();
    }

    public void page2_2_2(View view){
        Intent i = new Intent(Page2_2.this, Page2_2_2.class);
        startActivity(i);
        finish();
    }
