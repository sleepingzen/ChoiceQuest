...
public class Page2_2_2_3_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_2_2_3_2);
        View root = findViewById(R.id.page2_2_2_3_2);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.page2_2_2_3_2), (v, insets) -> {
