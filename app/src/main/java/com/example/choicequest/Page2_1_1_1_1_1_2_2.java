...
public class Page2_1_1_1_1_1_2_2 extends BaseActivity {

    private TextView myTextView;
    private String fullText;
    private MediaPlayer mediaPlayer;
    private MediaPlayer chachingSound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page2_1_1_1_1_1_2_2);
        View root = findViewById(R.id.page2_1_1_1_1_1_2_2);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.page2_1_1_1_1_1_2_2), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });

        myTextView = findViewById(R.id.tv_page2_1_1_1_1_1_2_2);

        fullText = myTextView.getText().toString();
        myTextView.setText("");

        chachingSound = MediaPlayer.create(this, R.raw.chaching);
        chachingSound.start();
